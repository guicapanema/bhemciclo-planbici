...
@section('content')
		...
		<div class="content is-medium">
			<div class="columns">
				<div class="column is-8 is-offset-2">
					<h1 class="has-text-centered has-text-white">Pedalar em BH...</h1>
	...
	<section class="section">
		<div class="content is-medium">
			<div class="columns">
				<div class="column is-8 is-offset-2">
					<h1 class="has-text-centered">O que é o Plano de Mobilidade por Bicicleta?</h1>
	...
	<section class="section notification is-primary">
		<div class="content is-medium">
			<div class="columns">
				<div class="column is-8 is-offset-2">
					<h1 class="has-text-centered has-text-white">O que é essa plataforma?</h1>
	...
	<section class="section notification is-white">
		<div class="content is-medium">
			<div class="columns">
				<div class="column is-8 is-offset-2">
					...
					<p class="has-text-centered">
						<a class="button is-large is-danger" href="/participe">Quero saber mais</a>
					</p>
				</div>
			</div>
		</div>
